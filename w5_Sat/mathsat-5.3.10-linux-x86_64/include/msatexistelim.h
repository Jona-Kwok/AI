/* -*- C -*-
 * 
 * MathSAT5 is copyrighted 2009-2016 by Fondazione Bruno Kessler, Trento, Italy,
...
#ifndef MSATEXISTELIM_H_INCLUDED
#define MSATEXISTELIM_H_INCLUDED
...
#endif /* MSATEXISTELIM_H_INCLUDED */
